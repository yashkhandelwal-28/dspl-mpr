# -*- coding: utf-8 -*-
"""Rainfall_Prediction with MachineLearning.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1bxwW31MHqVlDoIzjaS0dQbrbTN8GJfE_
"""
...
full_data.RainTomorrow.value_counts(normalize = True).plot(kind='bar', color= ['red','green'], alpha = 0.9, rot=0)
...
fig = plt.figure(figsize = (8,5))
oversampled.RainTomorrow.value_counts(normalize = True).plot(kind='bar', color= ['red','green'], alpha = 0.9, rot=0)
...
accuracy_scores = [0.638802, 0.664021, 0.658227, 0.678161, 0.682707, 0.684314, 0.685122]
roc_auc_scores = [0.705343, 0.733674, 0.727728, 0.747893, 0.752597, 0.754332, 0.755222]
coh_kap_scores = [0.339932, 0.406498, 0.390109, 0.435143, 0.447381, 0.449955, 0.451463]
tt = [0.217138, 0.013276, 1.909714, 0.404993, 0.188524, 0.189349, 0.333082]
